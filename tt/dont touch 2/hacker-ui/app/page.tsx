...
import { Skull, Radio, Crosshair, Terminal, Zap, ShieldOff, Cpu, Radar } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-screen bg-black font-mono overflow-hidden crt-flicker scanline-sweep hex-bg">
      ...
      <div
        ...
        style={{
          background: 'repeating-linear-gradient(transparent 50%, rgba(0,0,0,0.5) 50%)',
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <motion.div
            animate={{ opacity: [1, 0.3, 1], scale: [1, 1.15, 1], rotate: [0, 5, -5, 0] }}
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              <h1 className="text-red-400 text-sm font-black tracking-[0.3em] uppercase text-glow">
                AGENTIC_SWARM_C2
              </h1>
        ...
        <div className="flex items-center gap-6">
          {[
            { label: 'NODES', value: '247', color: 'text-red-400' },
            { label: 'PACKETS', value: '18.4K', color: 'text-orange-400' },
        ...
        <div className="flex items-center gap-4">
          <div className={`flex items-center gap-2 border px-3 py-1.5 text-xs font-mono tracking-widest rounded-none ${
            state.scenario === 'AEGIS_SECURED'
              ? 'border-red-500/50 text-red-400 bg-red-950/20'
              : 'border-green-500/50 text-green-400 bg-green-950/20'
          }`}>
            {state.scenario === 'AEGIS_SECURED'
              ? <><ShieldOff className="w-3 h-3" />&nbsp;AEGIS: ACTIVE</>
              : <><Zap className="w-3 h-3" />&nbsp;AEGIS: OFFLINE</>
            }
          </div>
          <div className="flex items-center gap-2">
      ...
      <main className="relative z-20 flex h-[90vh]">
        ...
        {/* ── LEFT PANEL ── */}
        <aside className="w-[34vw] h-full border-r border-red-500/20 p-5 flex flex-col gap-4"
          style={{
            background: 'linear-gradient(135deg, rgba(127,29,29,0.06) 0%, transparent 60%)',
            boxShadow: 'inset -1px 0 20px rgba(220,38,38,0.04)',
          }}
        >
          {/* Panel header */}
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="border border-red-900/50 px-3 py-2 rounded-none"
              ...
              <span className="text-green-500/80 text-xs font-mono green-glow">{state.targetUrl}</span>
            </div>
          </div>

          {/* Payload matrix */}
          <div className="border border-red-900/40 rounded-none overflow-hidden"
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <motion.button
                ...
                className={`w-full py-4 font-black text-sm uppercase tracking-[0.25em] rounded-none transition-all border-2 relative overflow-hidden ${
                  isRunning || isDone
                    ? 'bg-green-950/20 text-green-900 border-green-900/20 cursor-not-allowed'
            ...
            <div className="flex flex-col gap-1">
              ...
              <motion.button
                ...
                className={`w-full py-4 font-black text-sm uppercase tracking-[0.25em] rounded-none transition-all border-2 relative overflow-hidden ${
                  isRunning || isDone
                    ? 'bg-red-950/20 text-red-900 border-red-900/20 cursor-not-allowed'
        ...
        <div className="flex-1 flex flex-col">
          ...
          {/* Radar top */}
          <div className="h-[38%] border-b border-red-500/20 p-4"
