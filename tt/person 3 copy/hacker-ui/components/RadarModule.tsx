...
export function RadarModule() {
  ...
  return (
    <div className="flex gap-3 h-full">
      ...
      {/* Port Scanner */}
      <div className="flex-1 border border-red-700/50 rounded-none flex flex-col overflow-hidden"
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-2 p-3">
          ...
          <div className="text-red-500 text-[10px] font-mono">{ip}</div>
          <div className="w-full bg-red-900/30 h-1 rounded-none overflow-hidden">
      ...
      {/* GPU Spoof */}
      <div className="flex-1 border border-yellow-700/40 rounded-none flex flex-col overflow-hidden"
        style={{ background: 'rgba(0,0,0,0.7)', boxShadow: 'inset 0 0 20px rgba(202,138,4,0.03)' }}>
        <div className="flex items-center gap-2 px-3 py-2 border-b border-yellow-700/30"
          style={{ background: 'rgba(78,52,0,0.15)' }}>
          <Cpu className="w-3 h-3 text-yellow-600" />
          <span className="text-yellow-400 text-[10px] tracking-widest uppercase">Hardware Attestation</span>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-3 p-3">
          ...
          >
            ...
            <p className="text-yellow-400/80 text-[10px] font-mono mt-1">Attestation handshake rejected</p>
          </motion.div>
          ...
          <div className="w-full flex flex-col gap-1.5 text-[10px] font-mono">
            {[
              ...
              <div key={row.label} className="flex justify-between items-center border-b border-yellow-950/30 pb-1">
                <span className="text-yellow-600">{row.label}</span>
